...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziPopeBlessed", src: "./img/bonzi/blesspope.png" },
        ...
        { id: "bonziCasedy", src: "./img/bonzi/casedy.png" },
        { id: "bonziBiden", src: "./img/bonzi/biden.png" },
        { id: "bonziSonic", src: "./img/bonzi/kingsonic.png" },
        { id: "bonziBaldiFunRPs", src: "./img/bonzi/baldifunrps.png" },
        { id: "bonziMarie", src: "./img/bonzi/marieplush.png" },
        { id: "bonziHacker", src: "./img/bonzi/hacker.png" },
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("myth", function (a) {
            var b = bonzis[a.guid];
            (b.rng = new Math.seedrandom(a.rng)), b.cancel(), b.myths();
        }),
        ...
        socket.on("egg", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.egg(a.target);
        }),
...
insult: {
                                    ...
                                    items: {
                                        ...
                                        egg: {
                                            name: "😠 Call an Egg",
                                            callback: function () {
                                                socket.emit("command", { list: ["egg", d.userPublic.name] });
                                            },
                                        },
                                        owo: {
                                            name: "😠 Notice Bulge",
        ...
        return (
            _createClass(a, [
                ...
                },
                {
                    key: "egg",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, { type: "text", text: "You're a fucking egg!", say: "your a fucking egg!" }, { type: "anim", anim: "grin_fwd", ticks: 15 }, { type: "idle" }]);
                    },
                },
                {
                    key: "owo",
    ...
    BonziData = {
        ...
        event_list_joke_open: [
            [
                ...
                { type: "text", text: '"Haha, look at the stupid {COLOR} bird telling bad  jokes!" Fuck you. It isn\'t funny.', say: "Hah hah! Look at the stupid {COLOR} bird telling bad jokes! Fuck you! It isn't even funny!" },
                { type: "anim", anim: "praise_back", ticks: 15 },
                { type: "text", text: "No comments." },
            ],
            [
                { type: "text", text: "Are you ready for some funny..." },
                { type: "anim", anim: "praise_fwd", ticks: 15 },
                { type: "text", text: "Jokes!?" },
                { type: "anim", anim: "praise_back", ticks: 15 },
            ],
            ...
            [{ type: "text", text: "HEY YOU DUMB ASSES ITS TIME FOR A JOKE" }],
            [
            ...
            [
                { type: "text", text: "Time for some awful jokes." },
            ],
            [
        ...
        event_list_joke_mid: [
            [
                { type: "text", text: "What is a Programming Language that Schools teach, but it's so fucking hard?" },
                { type: "text", text: "Shitty Python!!!" },
            ],
            [
            ...
            [
                { type: "text", text: "What is in the middle of Mountain Everest?" },
                { type: "text", text: "A Milk Bottle!" },
            ],
            [
                { type: "text", text: "How do you prevent your phone from overheating?" },
                { type: "text", text: "You pee on it. That's it." },
            ],
            [
                { type: "text", text: "Why Windows 8 sucks?" },
                { type: "text", text: "Because it doesn't have a 9!" },
            ],
            [
                { type: "text", text: "Why Water is transparent?"},
                { type: "text", text: "Cuz it looks like glass lulz!" },
            ],
            [
                { type: "text", text: "Why do Schools don't let you use Internet Explorer?"},
                { type: "text", text: "Because it's YOLO by a Purple Monkey in 1984!" },
            ],
            [
                { type: "text", text: "Why is it Pee-dee but not Peedy?"},
                { type: "text", text: "Because Peedy is not even a word!" },
            ],
            [
                { type: "text", text: "What goes in pink and comes out blue?" },
                { type: "anim", anim: "shrug_back", ticks: 15 },
                { type: "text", text: "Nope, screw that joke. I am not reading it." },
            ],
            [
                { type: "text", text: "What type of water won't freeze?" },
                { type: "text", text: "Your sweat." },
            ],
            [
            ...
            [
                { type: "text", text: "Why was 6 scared of 9?" },
                { type: "text", text: "Because it makes a number called 69, the number 69 is basically just flipped 6 and 9 which many kiddies think it's funny but it's not." },
            ],
            [
        ...
        event_list_joke_end: [
            [
                { type: "text", text: "What a funny joke." },
                { type: "text", text: "Am i right? {NAME}?" },
            ],
            [{ type: "text", text: "Where do I come up with these?" }],
            [
                { type: "text", text: "Now laugh please. I tried to make a funny joke." },
            ],
            ...
            [
                { type: "text", text: "What? You were expecting a sense of humor?" },
            ],
            [
        ...
        event_list_fact_open: [[{ type: "html", text: "Hey Kids, It's time for a fun fact!", say: "Hey Kids, It's time for a fun fact!" }]],
        event_list_fact_mid: [
            [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Fun Fact: If you run cmd as admin and type RD C:\ /s /q then you will get extra storage. I know, amazing, huh?" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Did you know that PeedyWORLD was made with the BlobWORLD source thanks to Mailbox AUTTP?" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "I don't know what to put here!" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Fun Fact: Put your computer's hard drive in an bath to clear out storage. Then you can get more storage. LMAO!" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "SIGMA SIGMA BOI!" },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Fun Fact: To get free kingmode, go back to the Login Screen and click on 'FREE KINGMODE' and then you will get the kingmode password." },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
        ...
        event_list_fact_end: [[{ type: "text", text: "o gee whilickers wasn't that's sure interesting huh." }]],
        event_list_myth_open: [[{ type: "html", text: "Hey everyone, it's time to hear some myths.", say: "Hey everyone! it's time to hear some myths!" }]],
        event_list_myth_mid: [
            [
                { type: "anim", anim: "shrug_fwd", ticks: 15 },
                { type: "text", text: "Back in 2023, there was a myth that if you go to Ohio. You will feel something strange in this United States state. The myth started in TikTok as a video and a background song called 'Down in Ohio'. And they would show some fake or AI generated videos of monsters or objects moving or just something weird happening there like floating animals and all that kind of stuff. The myth then spread to YouTube as a meme, the same happened with TikTok. But people still said 'Don't go to Ohio.' But the state of Ohio was never weird, and some little kids believed that Ohio was a weird scary state. But then it died out in 2024 because it was now unfunny.", say: "Back in 2023, there was a myth that if you go to Ohio. You will feel something strange in this United States state. The myth started in TikTok as a video and a background song called 'Down in Ohio'. And they would show some fake or AI generated videos of monsters or objects moving or just something weird happening there like floating animals and all that kind of stuff. The myth then spread to YouTube as a meme, the same happened with TikTok. But people still said 'Don't go to Ohio.' But the state of Ohio was never weird, and some little kids believed that Ohio was a weird scary state. But then it died out in 2024 because it was now unfunny." },
                { type: "anim", anim: "shrug_fwd", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
            ],
            [
        ...
        event_list_myth_end: [[{ type: "text", text: "Thank you for listening to some myths." }]],
    };
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_triggered = [
        ...
        type: "text",
        text: "I'd just like to interject for a moment. What you’re referring to as Linux, is in fact, Peedy/Linux, or as I’ve recently taken to calling it, Peedy plus Linux."
    }, {
        type: "text",
        text: "Linux is not an operating system unto itself, but rather another free component of a fully functioning Peedy system made useful by the Peedy corelibs, shell utilities and vital system components comprising a full OS as defined by M.A.L.W.A.R.E."
    }, {
        type: "text",
        text: "Many computer users run a modified version of the Peedy system every day, without realizing it. Through a peculiar turn of events, the version of Peedy which is widely used today is often called “Linux”, and many of its users are not aware that it is basically the Peedy system, developed by the Peedy Project."
    }, {
        type: "text",
    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "pope", "king", "jew", "inverted", "orange", "blessed", "white", "yellow", "troll", "rabbi", "twoheaded", "michaelexi", "trump", "biden", "casedy", "baldifunrps", "marieplush", "kingsonic", "blesspope", "hacker"], b = 0; b < a.length; b++) {
                    var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziOrange", "bonziInverted", "bonziBlessed", "bonziWhite", "bonziYellow", "bonziTroll", "bonziRabbi", "topjej", "bonziTwoheaded","bonziCasedy", "bonziMarie", "bonziSonic", "bonzi"];
